...
import com.example.arthax.ui.theme.ArthaxIcons
    ...
    Column(
        ...
        SetupStep(
            ...
            if (state.folderDone) {
                ...
                Spacer(Modifier.height(8.dp))
                TextButton(onClick = { folderLauncher.launch(RecordingFolderHints.initialTreeUri()) }) {
                    Text("Change folder")
                }
            } else {
                ...
                Spacer(Modifier.height(12.dp))
                Button(onClick = { folderLauncher.launch(RecordingFolderHints.initialTreeUri()) }) {
                    Text("Select folder")
                }
            }
        }
